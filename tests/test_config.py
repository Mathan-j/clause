...
def test_defaults_match_the_spec() -> None:
    ...
    assert s.min_chunk_chars == 400  # noqa: PLR2004
    assert s.max_chunk_chars == 2000  # noqa: PLR2004
    assert s.window_chars == 1200  # noqa: PLR2004
    assert s.overlap_chars == 200  # noqa: PLR2004
    assert s.min_document_chars == 500  # noqa: PLR2004
    assert s.min_request_interval_s == 2.0  # noqa: PLR2004
    assert s.max_retries == 3  # noqa: PLR2004
...
def test_environment_overrides_defaults(monkeypatch) -> None:
    ...
    assert Settings().window_chars == 999  # noqa: PLR2004
